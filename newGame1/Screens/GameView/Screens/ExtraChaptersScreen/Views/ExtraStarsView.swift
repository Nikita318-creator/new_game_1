...
class ExtraStarsView: UIView {
    
    let star1 = ExtraStarView()
    let star2 = ExtraStarView()
    let star3 = ExtraStarView()
    ...
    private func setup() {
        ...
        [star1, star2, star3].forEach {
            $0.snp.makeConstraints { make in
                make.height.width.equalTo(7) // Устанавливаем размеры для звезд
            }
        }
    }
